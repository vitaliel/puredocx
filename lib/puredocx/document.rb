module PureDocx
  class Document
    attr_accessor :body_content, :header_content, :footer_content
    attr_reader   :file_path, :file_name, :brake, :new_page, :rels_constructor
    ...
    def footer(items)
      self.footer_content += items.join
    end
    ...
    def save!
      ...
      DocArchive.open(file_path, rels_constructor.rels) do |file|
        ...
        file.save_rels
        file.save_document_content(body_content, header_content, footer_content)
      end
    end
  end
end
